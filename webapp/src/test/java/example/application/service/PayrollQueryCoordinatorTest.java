...
class PayrollQueryCoordinatorTest {
    ...
    void test() {
...

        {
            ...
            contractRecordService.registerHourlyWage(employee, Date.of("2018-11-20"), wageCondition);
...

        {
            ...
            contractRecordService.registerHourlyWage(employee, Date.of("2018-11-25"), wageCondition);
